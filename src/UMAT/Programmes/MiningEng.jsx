...
function MiningEng() {
  ...
  let name = MIN.name;
  let college = MIN.university;
  let elective = electives;


 if (MIN.electives.includes(val[0][0]) && MIN.electives.includes(val[0][1]) && MIN.electives.includes(val[0][2])) {
   console.log('Your electives are not in line with this programme ');
   elective = true;
} else if (MIN.electives.includes(val[0][0]) && MIN.electives.includes(val[0][1]) && MIN.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (MIN.electives.includes(val[0][0]) && MIN.electives.includes(val[0][2]) && MIN.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (MIN.electives.includes(val[0][1]) && MIN.electives.includes(val[0][2]) && MIN.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme ');
  ...
  if (elective == true){
  let emath = 0;
  if(val[0][0] == MIN.main.emath){
     emath = oneGrade.substring(1)
    
  } else if(val[0][1] == MIN.main.emath){
     emath = twoGrade.substring(1)
  } else if(val[0][2] == MIN.main.emath){
  ...
  let chemistry = 0;
  if(val[0][0] == MIN.main.chemistry){
     chemistry = oneGrade.substring(1)
    
  } else if(val[0][1] == MIN.main.chemistry){
    chemistry = twoGrade.substring(1)
  } else if(val[0][2] == MIN.main.chemistry){
  ...
  let physics = 0;
  if(val[0][0] == MIN.main.physics){
     physics = oneGrade.substring(1)
    
  } else if(val[0][1] == MIN.main.physics){
    physics = twoGrade.substring(1)
  } else if(val[0][2] == MIN.main.physics){
  ...
  } else if(chemistry > MIN.scores.chemistry) {
    mainState = false;
 ...
 }else if(physics > MIN.scores.physics) {
    mainState = false;
