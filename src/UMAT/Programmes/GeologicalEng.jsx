...
function GeologicalEng() {
  ...
  let name = GEO.name;
  let college = GEO.university;
  let elective = electives;


 if (GEO.electives.includes(val[0][0]) && GEO.electives.includes(val[0][1]) && GEO.electives.includes(val[0][2])) {
   console.log('Your electives are not in line with this programme ');
   elective = true;
} else if (GEO.electives.includes(val[0][0]) && GEO.electives.includes(val[0][1]) && GEO.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (GEO.electives.includes(val[0][0]) && GEO.electives.includes(val[0][2]) && GEO.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (GEO.electives.includes(val[0][1]) && GEO.electives.includes(val[0][2]) && GEO.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme ');
  ...
  if (elective == true){
  let emath = 0;
  if(val[0][0] == GEO.main.emath){
     emath = oneGrade.substring(1)
    
  } else if(val[0][1] == GEO.main.emath){
     emath = twoGrade.substring(1)
  } else if(val[0][2] == GEO.main.emath){
  ...
  let chemistry = 0;
  if(val[0][0] == GEO.main.chemistry){
     chemistry = oneGrade.substring(1)
    
  } else if(val[0][1] == GEO.main.chemistry){
    chemistry = twoGrade.substring(1)
  } else if(val[0][2] == GEO.main.chemistry){
  ...
  let physics = 0;
  if(val[0][0] == GEO.main.physics){
     physics = oneGrade.substring(1)
    
  } else if(val[0][1] == GEO.main.physics){
    physics = twoGrade.substring(1)
  } else if(val[0][2] == GEO.main.physics){
  ...
  } else if(chemistry > GEO.scores.chemistry) {
    mainState = false;
 ...
 }else if(physics > GEO.scores.physics) {
    mainState = false;
