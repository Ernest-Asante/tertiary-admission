...
function MineralsEng() {
  ...
  let name = MNR.name;
  let college = MNR.university;
  let elective = electives;


 if (MNR.electives.includes(val[0][0]) && MNR.electives.includes(val[0][1]) && MNR.electives.includes(val[0][2])) {
   console.log('Your electives are not in line with this programme ');
   elective = true;
} else if (MNR.electives.includes(val[0][0]) && MNR.electives.includes(val[0][1]) && MNR.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (MNR.electives.includes(val[0][0]) && MNR.electives.includes(val[0][2]) && MNR.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (MNR.electives.includes(val[0][1]) && MNR.electives.includes(val[0][2]) && MNR.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme ');
  ...
  if (elective == true){
  let emath = 0;
  if(val[0][0] == MNR.main.emath){
     emath = oneGrade.substring(1)
    
  } else if(val[0][1] == MNR.main.emath){
     emath = twoGrade.substring(1)
  } else if(val[0][2] == MNR.main.emath){
  ...
  let chemistry = 0;
  if(val[0][0] == MNR.main.chemistry){
     chemistry = oneGrade.substring(1)
    
  } else if(val[0][1] == MNR.main.chemistry){
    chemistry = twoGrade.substring(1)
  } else if(val[0][2] == MNR.main.chemistry){
  ...
  let physics = 0;
  if(val[0][0] == MNR.main.physics){
     physics = oneGrade.substring(1)
    
  } else if(val[0][1] == MNR.main.physics){
    physics = twoGrade.substring(1)
  } else if(val[0][2] == MNR.main.physics){
  ...
  } else if(chemistry > MNR.scores.chemistry) {
    mainState = false;
 ...
 }else if(physics > MNR.scores.physics) {
    mainState = false;
