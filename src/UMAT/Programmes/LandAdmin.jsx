...
if (selectedOption !== "Home Economics" || selectedOption !== "Visual Arts") {
   ...
   if (!knust_failed.some(item => item.name === name)) {
      knust_failed.push({ name, college, reason:"This programme requires you to have studied a science related course, general art or business" });
  }
}
