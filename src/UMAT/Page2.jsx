  ...
  return (
    ...
    <div>
      <Select
        ...
        options={selectedOption == "Business"?(business):selectedOption =="Visual_Arts"?(visualArt):selectedOption =="Agric Science"?(agricScience):selectedOption =="Technical Programme"?
        (technical):selectedOption =="General Arts"?(generalArt):selectedOption =="General Science"?(science):selectedOption =="Home_Economics"?(homeEcons):""}
        isMulti
      />
