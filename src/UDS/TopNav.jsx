      ...
      <AppBar position="fixed" sx={{bgcolor:"white", marginBottom:10,display:'block'}}>
        <Toolbar>
         ...
         <img alt="holly" src={Holly2} style={{height:30,width:30,marginLeft:8}}/>
          ...
          <Button  variant="outlined" component="label" sx={{width:{xs:"45%",sm:"32%",md:"20%"},borderColor:lightGreen,borderRadius:20,marginRight:2,textAlign:"center",display:"block"}}>UDS GUIDE</Button>
