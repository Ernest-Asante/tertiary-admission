...
import CommunityNutrition from './Programmes/CommunityNutrition';
import Dietetics from './Programmes/Dietetics';
import MedicalImaging from './Programmes/MedicalImaging';
import MedicalLaboratory from './Programmes/MedicalLaboratory';
...
function Page6() {
  ...
  if( coreState == true){
    ...
    if (!udscore_failed.some(item => item.name === "UDS")) {
      udscore_failed.push({name:"KNUST" ,reason:"You have failed some of your core subject." });
  }
  } 
  ...
  return (
    ...
    {coreState && <CommunityNutrition />}
    {coreState && <Dietetics />}
    {coreState && <MedicalImaging />}
    {coreState && <MedicalLaboratory />}
