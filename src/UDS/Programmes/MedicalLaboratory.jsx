...
function MedicalLaboratory() {
  ...
  let name = MDL.name;
  let college = MDL.university;
  let elective = electives;


 if (MDL.electives.includes(val[0][0]) && MDL.electives.includes(val[0][1]) && MDL.electives.includes(val[0][2])) {
   console.log('Your electives are not in line with this programme ');
   elective = true;
} else if (MDL.electives.includes(val[0][0]) && MDL.electives.includes(val[0][1]) && MDL.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (MDL.electives.includes(val[0][0]) && MDL.electives.includes(val[0][2]) && MDL.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (MDL.electives.includes(val[0][1]) && MDL.electives.includes(val[0][2]) && MDL.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme ');
...
if (MDL.req.includes(val[0][0]) && MDL.req.includes(val[0][1])) {
   console.log('Electives req included');
   elective = true;
} else if (MDL.req.includes(val[0][0]) && MDL.req.includes(val[0][2])) {
   console.log('Electives req included');
   elective = true;
} else if (MDL.req.includes(val[0][0]) && MDL.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else if (MDL.req.includes(val[0][1]) && MDL.req.includes(val[0][2])) {
   console.log('Electives req included');
   elective = true;
} else if (MDL.req.includes(val[0][1]) && MDL.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else if (MDL.req.includes(val[0][2]) && MDL.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme');
  ...
  if (elective == true){
  let biology = 0;
  if(val[0][0] == MDL.main.biology){
     biology = oneGrade.substring(1)
    
  } else if(val[0][1] == MDL.main.biology){
     biology = twoGrade.substring(1)
  } else if(val[0][2] == MDL.main.biology){
  ...
  let chemistry = 0;
  if(val[0][0] == MDL.main.chemistry){
     chemistry = oneGrade.substring(1)
    
  } else if(val[0][1] == MDL.main.chemistry){
    chemistry = twoGrade.substring(1)
  } else if(val[0][2] == MDL.main.chemistry){
  ...
  } else if(chemistry > MDL.scores.chemistry) {
    mainState = false;
