...
function MedicalImaging() {
  ...
  let name =MDI.name;
  let college =MDI.university;
  let elective = electives;


 if (MDI.electives.includes(val[0][0]) && MDI.electives.includes(val[0][1]) &&MDI.electives.includes(val[0][2])) {
   console.log('Your electives are not in line with this programme ');
   elective = true;
} else if (MDI.electives.includes(val[0][0]) && MDI.electives.includes(val[0][1]) &&MDI.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (MDI.electives.includes(val[0][0]) && MDI.electives.includes(val[0][2]) &&MDI.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (MDI.electives.includes(val[0][1]) &&MDI.electives.includes(val[0][2]) &&MDI.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme ');
...
if (MDI.req.includes(val[0][0]) &&MDI.req.includes(val[0][1])) {
   console.log('Electives req included');
   elective = true;
} else if (MDI.req.includes(val[0][0]) &&MDI.req.includes(val[0][2])) {
   console.log('Electives req included');
   elective = true;
} else if (MDI.req.includes(val[0][0]) &&MDI.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else if (MDI.req.includes(val[0][1]) &&MDI.req.includes(val[0][2])) {
   console.log('Electives req included');
   elective = true;
} else if (MDI.req.includes(val[0][1]) &&MDI.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else if (MDI.req.includes(val[0][2]) &&MDI.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme');
  ...
  if (elective == true){
  let biology = 0;
  if(val[0][0] ==MDI.main.biology){
     biology = oneGrade.substring(1)
    
  } else if(val[0][1] ==MDI.main.biology){
     biology = twoGrade.substring(1)
  } else if(val[0][2] ==MDI.main.biology){
  ...
  let chemistry = 0;
  if(val[0][0] ==MDI.main.chemistry){
     chemistry = oneGrade.substring(1)
    
  } else if(val[0][1] ==MDI.main.chemistry){
    chemistry = twoGrade.substring(1)
  } else if(val[0][2] ==MDI.main.chemistry){
  ...
  } else if(chemistry >MDI.scores.chemistry) {
    mainState = false;
