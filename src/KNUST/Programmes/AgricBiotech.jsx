...
function AgricBiotech() {
  ...
  let name = ABT.name;
  let college = ABT.university;
  let elective = electives;


  if (ABT.electives.includes(val[0][0]) && ABT.electives.includes(val[0][1]) && ABT.electives.includes(val[0][2])) {
    console.log('Your electives are not in line with this programme ');
    elective = true;
 } else if (ABT.electives.includes(val[0][0]) && ABT.electives.includes(val[0][1]) && ABT.electives.includes(val[0][3])) {
    console.log('Your electives are  in line with this programme ');
    elective = true;
 } else if (ABT.electives.includes(val[0][0]) && ABT.electives.includes(val[0][2]) && ABT.electives.includes(val[0][3])) {
    console.log('Your electives are  in line with this programme ');
    elective = true;
 } else if (ABT.electives.includes(val[0][1]) && ABT.electives.includes(val[0][2]) && ABT.electives.includes(val[0][3])) {
    console.log('Your electives are  in line with this programme ');
    elective = true;
 } else {
    console.log('Your electives are not in line with this programme ');
    ...
    if (!knust_failed.some(item => item.name === name)) {
       knust_failed.push({ name, college, reason:"Your electives are not in line with this programme. You will need  chemistry and physics, biology, elective math or general ABTiculture, animal husbandry, crop and horticulture" });
   }
 }
...
if (elective == true){
  ...
  let chemistry = 0;
  if(val[0][0] === ABT.main.chemistry){
    chemistry = oneGrade.substring(1)
  } else if(val[0][1] === ABT.main.chemistry){
    chemistry = twoGrade.substring(1)
  } else if(val[0][2] === ABT.main.chemistry){
  ...
  if (chemistry > ABT.scores.chemistry) {
    mainState = false;
