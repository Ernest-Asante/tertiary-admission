...
function PhysicianAssistant() {
  ...
  const MPA = {
      name: 'Bsc. Physician Assistanship',
      grade: 6,
  ...
  let name =MPA.name;
  let college =MPA.university;
  let elective = electives;


 if (MPA.electives.includes(val[0][0]) && MPA.electives.includes(val[0][1]) &&MPA.electives.includes(val[0][2])) {
   console.log('Your electives are not in line with this programme ');
   elective = true;
} else if (MPA.electives.includes(val[0][0]) && MPA.electives.includes(val[0][1]) &&MPA.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (MPA.electives.includes(val[0][0]) && MPA.electives.includes(val[0][2]) &&MPA.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (MPA.electives.includes(val[0][1]) &&MPA.electives.includes(val[0][2]) &&MPA.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme ');
...
if (MPA.req.includes(val[0][0]) &&MPA.req.includes(val[0][1])) {
   console.log('Electives req included');
   elective = true;
} else if (MPA.req.includes(val[0][0]) &&MPA.req.includes(val[0][2])) {
   console.log('Electives req included');
   elective = true;
} else if (MPA.req.includes(val[0][0]) &&MPA.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else if (MPA.req.includes(val[0][1]) &&MPA.req.includes(val[0][2])) {
   console.log('Electives req included');
   elective = true;
} else if (MPA.req.includes(val[0][1]) &&MPA.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else if (MPA.req.includes(val[0][2]) &&MPA.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme');
  ...
  if (elective == true){
  let biology = 0;
  if(val[0][0] ==MPA.main.biology){
     biology = oneGrade.substring(1)
    
  } else if(val[0][1] ==MPA.main.biology){
     biology = twoGrade.substring(1)
  } else if(val[0][2] ==MPA.main.biology){
  ...
  let chemistry = 0;
  if(val[0][0] ==MPA.main.chemistry){
     chemistry = oneGrade.substring(1)
    
  } else if(val[0][1] ==MPA.main.chemistry){
    chemistry = twoGrade.substring(1)
  } else if(val[0][2] ==MPA.main.chemistry){
  ...
  } else if(chemistry >MPA.scores.chemistry) {
    mainState = false;
