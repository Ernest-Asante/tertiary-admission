...
function Pharmacy() {
  ...
  let name = PHA.name;
  let college = PHA.university;
  let elective = electives;


 if (PHA.electives.includes(val[0][0]) && PHA.electives.includes(val[0][1]) && PHA.electives.includes(val[0][2])) {
   console.log('Your electives are not in line with this programme ');
   elective = true;
} else if (PHA.electives.includes(val[0][0]) && PHA.electives.includes(val[0][1]) && PHA.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (PHA.electives.includes(val[0][0]) && PHA.electives.includes(val[0][2]) && PHA.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (PHA.electives.includes(val[0][1]) && PHA.electives.includes(val[0][2]) && PHA.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme ');
...
if (PHA.req.includes(val[0][0]) && PHA.req.includes(val[0][1])) {
   console.log('Electives req included');
   elective = true;
} else if (PHA.req.includes(val[0][0]) && PHA.req.includes(val[0][2])) {
   console.log('Electives req included');
   elective = true;
} else if (PHA.req.includes(val[0][0]) && PHA.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else if (PHA.req.includes(val[0][1]) && PHA.req.includes(val[0][2])) {
   console.log('Electives req included');
   elective = true;
} else if (PHA.req.includes(val[0][1]) && PHA.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else if (PHA.req.includes(val[0][2]) && PHA.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme');
  ...
  if (elective == true){
  let biology = 0;
  if(val[0][0] == PHA.main.biology){
     biology = oneGrade.substring(1)
    
  } else if(val[0][1] == PHA.main.biology){
     biology = twoGrade.substring(1)
  } else if(val[0][2] == PHA.main.biology){
  ...
  let chemistry = 0;
  if(val[0][0] == PHA.main.chemistry){
     chemistry = oneGrade.substring(1)
    
  } else if(val[0][1] == PHA.main.chemistry){
    chemistry = twoGrade.substring(1)
  } else if(val[0][2] == PHA.main.chemistry){
  ...
  } else if(chemistry > PHA.scores.chemistry) {
    mainState = false;
