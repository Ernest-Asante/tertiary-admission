...
function BiologicalScience() {
  ...
  let name = BSC.name;
  let college = BSC.university;
  let elective = electives;


 if (BSC.electives.includes(val[0][0]) && BSC.electives.includes(val[0][1]) && BSC.electives.includes(val[0][2])) {
   console.log('Your electives are not in line with this programme ');
   elective = true;
} else if (BSC.electives.includes(val[0][0]) && BSC.electives.includes(val[0][1]) && BSC.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (BSC.electives.includes(val[0][0]) && BSC.electives.includes(val[0][2]) && BSC.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (BSC.electives.includes(val[0][1]) && BSC.electives.includes(val[0][2]) && BSC.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme ');
...
if (BSC.req.includes(val[0][0]) && BSC.req.includes(val[0][1])) {
   console.log('Electives req included');
   elective = true;
} else if (BSC.req.includes(val[0][0]) && BSC.req.includes(val[0][2])) {
   console.log('Electives req included');
   elective = true;
} else if (BSC.req.includes(val[0][0]) && BSC.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else if (BSC.req.includes(val[0][1]) && BSC.req.includes(val[0][2])) {
   console.log('Electives req included');
   elective = true;
} else if (BSC.req.includes(val[0][1]) && BSC.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else if (BSC.req.includes(val[0][2]) && BSC.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme');
  ...
  if (elective == true){
  let biology = 0;
  if(val[0][0] == BSC.main.biology){
     biology = oneGrade.substring(1)
    
  } else if(val[0][1] == BSC.main.biology){
     biology = twoGrade.substring(1)
  } else if(val[0][2] == BSC.main.biology){
  ...
  let chemistry = 0;
  if(val[0][0] == BSC.main.chemistry){
     chemistry = oneGrade.substring(1)
    
  } else if(val[0][1] == BSC.main.chemistry){
    chemistry = twoGrade.substring(1)
  } else if(val[0][2] == BSC.main.chemistry){
  ...
  } else if(chemistry > BSC.scores.chemistry) {
    mainState = false;
