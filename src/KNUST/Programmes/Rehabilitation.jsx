...
if (selectedOption !== "Agric Science" || selectedOption !== "Technical Programme") {
   ...
   if (!knust_failed.some(item => item.name === name)) {
      knust_failed.push({ name, college, reason:"This programme requires you to have studied a general science , art, business, or vocational course" });
  }
}
