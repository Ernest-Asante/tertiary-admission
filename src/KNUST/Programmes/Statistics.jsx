...
if (elective == true){
  ...
  let emath = 0;
  if(val[0][0] === STC.main.emath){
    emath = oneGrade.substring(1)
  } else if(val[0][1] === STC.main.emath){
    emath = twoGrade.substring(1)
  } else if(val[0][2] === STC.main.emath){
 ...
 if(mainState == true){
    if(val[0][0] !==  STC.main.emath){
      ...
      if(val[0][1] !== STC.main.emath){
        array.push( twoGrade.substring(1))
     }
      if(val[0][2] !== STC.main.emath){
        array.push( threeGrade.substring(1))
     }
      if(val[0][3] !== STC.main.emath){
