...
function  FoodScience () {
  ...
  let name = FDT.name;
  let college = FDT.university;
  let elective = electives;


 if (FDT.electives.includes(val[0][0]) && FDT.electives.includes(val[0][1]) && FDT.electives.includes(val[0][2])) {
   console.log('Your electives are not in line with this programme ');
   elective = true;
} else if (FDT.electives.includes(val[0][0]) && FDT.electives.includes(val[0][1]) && FDT.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (FDT.electives.includes(val[0][0]) && FDT.electives.includes(val[0][2]) && FDT.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (FDT.electives.includes(val[0][1]) && FDT.electives.includes(val[0][2]) && FDT.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme ');
...
if (FDT.req.includes(val[0][0]) && FDT.req.includes(val[0][1])) {
   console.log('Electives req included');
   elective = true;
} else if (FDT.req.includes(val[0][0]) && FDT.req.includes(val[0][2])) {
   console.log('Electives req included');
   elective = true;
} else if (FDT.req.includes(val[0][0]) && FDT.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else if (FDT.req.includes(val[0][1]) && FDT.req.includes(val[0][2])) {
   console.log('Electives req included');
   elective = true;
} else if (FDT.req.includes(val[0][1]) && FDT.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else if (FDT.req.includes(val[0][2]) && FDT.req.includes(val[0][3])) {
   console.log('Electives req included');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme');
  ...
  if (elective == true){
  let biology = 0;
  if(val[0][0] == FDT.main.biology){
     biology = oneGrade.substring(1)
    
  } else if(val[0][1] == FDT.main.biology){
     biology = twoGrade.substring(1)
  } else if(val[0][2] == FDT.main.biology){
  ...
  let chemistry = 0;
  if(val[0][0] == FDT.main.chemistry){
     chemistry = oneGrade.substring(1)
    
  } else if(val[0][1] == FDT.main.chemistry){
    chemistry = twoGrade.substring(1)
  } else if(val[0][2] == FDT.main.chemistry){
  ...
  } else if(chemistry > FDT.scores.chemistry) {
    mainState = false;
