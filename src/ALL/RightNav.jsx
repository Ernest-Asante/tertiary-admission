...
function RightNav() {
  ...
  return ( 
    <>
  <Box  flex={3} p={0} sx={{marginLeft:4,display:{xs:"none",md:"block"},width:{xs:'100%',md:"25%"}}}>
      
   
      
        
         
  <Card   sx={{height:"auto",marginBottom:1,margin:0,borderRadius:5,marginLeft:3}}> 
  <p>PASS WASSCE WITH EXCELLENCE</p>
          <hr/>
          <div style={{display: "flex"}}>
            <img src={rem} alt="none" style={{height: "35px", width: "35px", borderRadius: "20px", marginRight: "7px"}}/>
            <p>EMPIRE OF GRACE COLLEGE</p>
          </div>
          <div>
