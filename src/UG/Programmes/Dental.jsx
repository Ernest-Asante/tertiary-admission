...
function Dental() {
 ...
 if (elective == true){
   ...
   let chemistry;
   if(val[0][0] === DEN.main.chemistry){
     chemistry = oneGrade.substring(1)
   } else if(val[0][1] === DEN.main.chemistry){
     chemistry = twoGrade.substring(1)
   } else if(val[0][2] === DEN.main.chemistry){
      chemistry = threeGrade.substring(1)
   } else  if(val[0][3] === DEN.main.chemistry){
   ...
   if (chemistry > DEN.scores.chemistry) {
     elective = false;
 ...
 if (DEN.electives.includes(val[0][0]) && DEN.electives.includes(val[0][1]) && DEN.electives.includes(val[0][2])) {
   console.log('Your electives are not in line with this programme ');
   elective = true;
} else if (DEN.electives.includes(val[0][0]) && DEN.electives.includes(val[0][1]) && DEN.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (DEN.electives.includes(val[0][0]) && DEN.electives.includes(val[0][2]) && DEN.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else if (DEN.electives.includes(val[0][1]) && DEN.electives.includes(val[0][2]) && DEN.electives.includes(val[0][3])) {
   console.log('Your electives are  in line with this programme ');
   elective = true;
} else {
   console.log('Your electives are not in line with this programme ');
